...
[![npm](https://img.shields.io/npm/v/@browser-automation-hub%2Fva-vista-browser-automation.svg)](https://www.npmjs.com/package/@browser-automation-hub/va-vista-browser-automation)
...
This project gives you a **complete browser automation scaffold** for VA VistA using Puppeteer (self-hosted, open source) or [Anchor Browser](https://anchorbrowser.io) (cloud, managed, production-ready).

This system requires **MFA** (ID.me / Login.gov / PIV Card). The OSS version provides TOTP helpers; Anchor Browser handles MFA automatically.
...
*Built with ❤️ for developers who need to automate VA VistA without wrestling with its API limitations. Powered by [Anchor Browser](https://anchorbrowser.io) for cloud-scale automation.*
