/**
 * basic-login.js — Basic login example for VA VistA
...
async function main() {
  ...
  try {
    log('Starting VA VistA automation (Open Source mode)');
    ...
    const result = await login_va_access(page, {
    ...
    // const data = await schedule_appointment(page, {});
    // log('Data:', data);
